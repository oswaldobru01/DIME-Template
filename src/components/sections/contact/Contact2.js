    ...
    <section id="contact">
      <div className="pt-60px md:pt-100px lg:pt-30 pb-20 md:pb-100px">
        <div className="container">
          <div className="flex flex-col xl:flex-row xl:justify-between xl:items-center gap-50px xl:gap-45px 2xl:gap-5 px-5 py-30px xl:p-50px bg-cream-light-color dark:bg-primary-color-light border border-body-color dark:border-seondary-color rounded-15px">
            {/* <!-- section heading --> */}
            <div>
